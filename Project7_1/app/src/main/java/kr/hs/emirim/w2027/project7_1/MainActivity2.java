package kr.hs.emirim.w2027.project7_1;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.item_img01:
                imgV.setImageResource(R.drawable.im10);
                return  true;
            case R.id.item_img02:
                imgV.setImageResource(R.drawable.img11);
                return  true;
            case R.id.item_img03:
                imgV.setImageResource(R.drawable.img12);
                return  true;
        }
        return false;
    }
