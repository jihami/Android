package kr.hs.emirim.w2027.ex10_19_20;
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                ...
                case R.id.btn_homepage:
                    ...
                    break;
                case R.id.btn_map:
                    uri = Uri.parse("https://maps.google.co.kr/maps?q="+37.46668782890223 + ","+126.93285435387054 + "&z=15");
                    intent = new Intent(Intent.ACTION_VIEW, uri);
                    break;
                case R.id.btn_search:
                    ...
                    break;
                case R.id.btn_sms:
                    uri = Uri.parse("smsto:"+Uri.encode("010-2222-3333"));
